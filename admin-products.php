    ...
    <body>
        ...
        <section id="admin-panel" class="admin-panel">
            ...
            if(isset($_POST['update'])) {
              $updateQuery = "UPDATE products SET product_type='$_POST[product_type]', product_name='$_POST[product_name]', product_desc='$_POST[product_desc]', product_q='$_POST[product_q]', product_price='$_POST[product_price]' WHERE id='$_POST[id]'";
            ...
            if(isset($_POST['add'])) {
              ...
              $insertQuery = "INSERT INTO products (product_type, product_name, product_desc, product_q, product_price) VALUES ('$product_type', '$product_name', '$product_desc', '$product_q', '$product_price')";
