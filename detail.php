                ...
                <div class="container">
                    <div class="row mb-5">
                        <div class="product-content col-lg ">
                            ...
                            <!-- Product Slider-->
                            <div class="product-slider col-lg-5 col-md-6">
                                <div id="carousel-indicators" class="carousel slide" data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner border-img">
                                        <div class="carousel-item active">
                                            <img src="assets/img/candle1.jpeg" class="d-block img-fluid" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="assets/img/candle2.jpeg" class="d-block img-fluid" alt="...">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- PProduct Details-->
                            <div class="product-about col-lg-5 col-md-6">
                                <h4>Świeca sojowa</h4>
                                <p class="text-muted">£100</p>
                                <h2 class="product-desc">Opis produktu</strong></h2>
                                <h2 class="text-sm mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ut ullamcorper leo, eget euismod orci. Cum sociis natoque penatibus et magnis dis parturient montes nascetur ridiculus mus. Vestibulum ultricies aliquam convallis.</h2>
                                <div class="mb-4">
                                        <a class="btn btn-buy" href="cart.html">Kup teraz</a>
                                </div>
                            </div>
                        </div>
                    </div>
