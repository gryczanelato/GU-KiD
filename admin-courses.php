    ...
    <body>
        ...
        <section id="admin-panel" class="admin-panel">
            ...
            if(isset($_POST['update'])) {
              $updateQuery = "UPDATE courses SET course_name='$_POST[course_name]', course_desc='$_POST[course_desc]', course_date='$_POST[course_date]', course_price='$_POST[course_price]' WHERE id='$_POST[id]'";
            ...
            if(isset($_POST['add'])) {
              ...
              $insertQuery = "INSERT INTO courses (course_name, course_desc, course_date, course_price) VALUES ('$course_name', '$course_desc', '$course_date', '$course_price')";
